                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        handleNotificationSettingChange("transactions", checked)
                      }
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        handleNotificationSettingChange("marketing", checked)
                      }
                    />
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        Display account balance without requiring authentication
                      </p>
                    </div>
                    <Switch
                      id="showBalance"
                      ...
                      onCheckedChange={(checked) =>
                        handlePrivacySettingChange("showBalance", checked)
                      }
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        Allow us to track your activity for better service
                      </p>
                    </div>
                    <Switch
                      id="activityTracking"
                      ...
                      onCheckedChange={(checked) =>
                        handlePrivacySettingChange("activityTracking", checked)
                      }
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        handlePrivacySettingChange("dataSharing", checked)
                      }
                    />
                  </div>
